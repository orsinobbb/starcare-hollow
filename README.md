...
這個資料夾包含完整遊戲設計、美術生成提示，以及一個具小鎮累積、永久收藏、建築升級與三種可愛配對小遊戲的瀏覽器原型。
...
1. 先從 [小鎮核心原型](prototype/README.md) 完成藥園、委託與小遊戲星願，收錄星願手札並確認跨系統累積感。
...
- [核心小遊戲玩法](docs/01_CORE_GAMEPLAY.md)
...
- [好友遊戲偏好與整合系統規格](docs/11_FRIEND_PLAYSTYLE_SYSTEM_SPEC.md)
